...
BEGIN TRY
    ...
    SET id_rol = @idRolAdministrador, nombre = N'Admin', apellido = N'Desarrollo',
        correo = N'admin.seed@ejemplo.invalid', clave = N'$2a$12$eBa/mNaeqo3LSGn9hVAik.DscPJxIzpW6skQybIrVJJJtNg5n9kCi',
        estado = 1, intentos_fallidos = 0
    WHERE dni = 90000001;
    IF @@ROWCOUNT = 0
        INSERT dbo.USUARIO (id_rol, dni, nombre, apellido, correo, clave, estado, intentos_fallidos, fecha_registro)
        VALUES (@idRolAdministrador, 90000001, N'Admin', N'Desarrollo', N'admin.seed@ejemplo.invalid', N'$2a$12$eBa/mNaeqo3LSGn9hVAik.DscPJxIzpW6skQybIrVJJJtNg5n9kCi', 1, 0, GETDATE());

    UPDATE dbo.USUARIO
    SET id_rol = @idRolEncargado, nombre = N'Encargado', apellido = N'Desarrollo',
        correo = N'encargado.seed@ejemplo.invalid', clave = N'$2a$12$sD.QdOKFYYD7Nqv27DGA2eQMMuar5Fs.eVcRlct4bK7q3unW306n6',
        estado = 1, intentos_fallidos = 0
    WHERE dni = 90000002;
    IF @@ROWCOUNT = 0
        INSERT dbo.USUARIO (id_rol, dni, nombre, apellido, correo, clave, estado, intentos_fallidos, fecha_registro)
        VALUES (@idRolEncargado, 90000002, N'Encargado', N'Desarrollo', N'encargado.seed@ejemplo.invalid', N'$2a$12$sD.QdOKFYYD7Nqv27DGA2eQMMuar5Fs.eVcRlct4bK7q3unW306n6', 1, 0, GETDATE());

    UPDATE dbo.USUARIO
    SET id_rol = @idRolVendedor, nombre = N'Vendedor', apellido = N'Desarrollo',
        correo = N'vendedor.seed@ejemplo.invalid', clave = N'$2a$12$L2JqegTxRoD8hsxuSJHRteY4piJbXTvueORhg5TSZBIBL0FuWm7eC',
        estado = 1, intentos_fallidos = 0
    WHERE dni = 90000003;
    IF @@ROWCOUNT = 0
        INSERT dbo.USUARIO (id_rol, dni, nombre, apellido, correo, clave, estado, intentos_fallidos, fecha_registro)
        VALUES (@idRolVendedor, 90000003, N'Vendedor', N'Desarrollo', N'vendedor.seed@ejemplo.invalid', N'$2a$12$L2JqegTxRoD8hsxuSJHRteY4piJbXTvueORhg5TSZBIBL0FuWm7eC', 1, 0, GETDATE());
